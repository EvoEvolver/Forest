    ...
    if (nodes.length === 0) {
        ...
        return (
            <Grid container height="100vh" width="100vw" flexDirection="column">
                <IconButton aria-label="delete" size="small" style={{position: "absolute", right: "0", top: "0"}}
                            onClick={() => setShowFocusPage(false)}>
                ...
                <Grid item
                    ...
                    <OtherNodesLayer nodes={siblingNodes} selectedNode={selectedNode}
